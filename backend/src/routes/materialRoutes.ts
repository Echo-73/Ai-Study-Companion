...
import { upload, requirePersistentStorage } from '../middleware/uploadMiddleware';
...
materialRouter.post('/upload', requireProjectOwnership, materialUploadRateLimiter, requirePersistentStorage, upload.single('file'), (req, res, next) =>
